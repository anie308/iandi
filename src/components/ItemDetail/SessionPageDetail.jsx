...
import { Sessions, faqArr } from "../../data";
     ...
     <div className="w-fit mt-[40px] grid sm:grid-cols-2 md:grid-cols-3 justify-center gap-6">
        {
            ...
            .map(({title, id, createdAt, slug}) =>(
                <div className="min-w-[320px] max-w-[320px] h-[420px] min-h-[420px]   max-h-[420px]   flex flex-col   rounded-[15px] bg-primary justify-between" key={id}>
