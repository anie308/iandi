...
function SupportSection() {
  return (
    <div>
      <div className='mt-[150px] mb-[40px]  w-full flex flex-col md:flex-row '>
      ...
      <p className='font-raleway font-[800] text-[18px] md:text-[26px] py-[10px]'>Book a session with our experts for a <span className='text-[#4395C1]'>detailed analysis</span> <br className='hidden md:block'/> and <span className='text-[#4395C1]'>individual consultation</span></p>
      ...
      <Link to='/support' className='mt-[20px] bg-[#4395C1] text-white px-[20px] py-[8px] rounded-[10px] w-fit font-lato'>
        Find Out More 
      </Link>
      </div>
    </div>
